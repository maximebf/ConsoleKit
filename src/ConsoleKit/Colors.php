...
class Colors {
   ...
   * @return string
   */
  static function colorize($text, $fgcolor = null, $bgcolor = null) {
    $colors = '';
    if ($bgcolor) {
   ...
   * @return string
   */
  static function colorizeLines($text, $fgcolor = null, $bgcolor = null) {
    $lines = explode("\n", $text);
   ...
   * @return int
   */
  static function getColorCode($color, $options = array()) {
    $code = (int) $color;
    if (is_string($color)) {
   ...
   * @return string
   */
  static function getFgColorString($colorCode) {
   ...
   * @return string
   */
  static function getBgColorString($colorCode) {
    list($color, $options) = self::extractColorAndOptions($colorCode);
